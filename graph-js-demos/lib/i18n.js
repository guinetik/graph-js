...
// Analysis runs in workers for optimal performance!`
    ...
    showcase: {
      ...
      networkAnalysis: {
        ...
        degreeDescription: 'Counts the number of direct connections to a node. The simplest centrality measure - identifies hubs and highly connected nodes.',
        betweennessCentrality: 'Betweenness Centrality',
        betweennessDescription: 'Measures how often a node appears on shortest paths between other nodes. Identifies bridge nodes and information bottlenecks.',
        clusteringCoefficient: 'Clustering Coefficient',
        clusteringDescription: 'Measures how connected a node\'s neighbors are to each other. Detects tightly-knit groups and local community structure.',
        eigenvectorCentrality: 'Eigenvector Centrality',
        eigenvectorDescription: 'Measures node importance based on the importance of its neighbors. Identifies influential nodes connected to other influential nodes.',
        pageRankCentrality: 'PageRank Centrality',
        pagerankDescription: 'Similar to eigenvector centrality, measures node importance based on connections. Popularized by Google\'s PageRank algorithm.',
        cliqueCount: 'Clique Count',
        cliquesDescription: 'Counts how many maximal cliques (complete subgraphs) a node belongs to. Identifies nodes in dense, tightly-knit communities. Warning: computationally expensive.',
        closenessCentrality: 'Closeness Centrality',
        closenessDescription: 'Measures how close a node is to all other nodes based on average shortest path length. Identifies nodes that can quickly reach the entire network.',
        egoDensity: 'Ego Density',
        egoDensityDescription: 'Measures the density of connections among a node\'s immediate neighbors. Quantifies local cohesion around a node.',
        eigenvectorLaplacian: 'Eigenvector (Laplacian) - for Spectral layout',
        eigenvectorLaplacianDescription: 'Laplacian eigenvector centrality used for spectral graph analysis. Useful for spectral layout algorithms.',
        ...
        cliquesName: 'Cliques',
        closenessName: 'Closeness',
        egoDensityName: 'Ego Density',
        highlightCliqueEdges: '🎨 Highlight Clique Edges',
        cliqueEdgesDescription: 'Color edges that are part of triangles/cliques'
      },
      layoutAlgorithm: {
  ...
  pt: {
    ...
    showcase: {
      ...
      networkAnalysis: {
        ...
        unselectAll: 'Desselecionar Todas',
        degreeCentrality: 'Centralidade de Grau',
        degreeDescription: 'Conta o número de conexões diretas de um nó. A medida de centralidade mais simples - identifica hubs e nós altamente conectados.',
        betweennessCentrality: 'Centralidade de Intermediação',
        betweennessDescription: 'Mede com que frequência um nó aparece nos caminhos mais curtos entre outros nós. Identifica nós ponte e gargalos de informação.',
        clusteringCoefficient: 'Coeficiente de Agrupamento',
        clusteringDescription: 'Mede o quão conectados os vizinhos de um nó estão entre si. Detecta grupos coesos e estrutura de comunidade local.',
        eigenvectorCentrality: 'Centralidade de Eigenvector',
        eigenvectorDescription: 'Mede a importância de um nó com base na importância de seus vizinhos. Identifica nós influentes conectados a outros nós influentes.',
        pageRankCentrality: 'Centralidade PageRank',
        pagerankDescription: 'Similar à centralidade de eigenvector, mede a importância do nó com base em conexões. Popularizado pelo algoritmo PageRank do Google.',
        cliqueCount: 'Contagem de Cliques',
        cliquesDescription: 'Conta quantos cliques maximais (subgrafos completos) um nó pertence. Identifica nós em comunidades densas e coesas. Aviso: computacionalmente caro.',
        closenessCentrality: 'Centralidade de Proximidade',
        closenessDescription: 'Mede o quão próximo um nó está de todos os outros nós com base no comprimento médio do caminho mais curto. Identifica nós que podem alcançar rapidamente toda a rede.',
        egoDensity: 'Densidade Ego',
        egoDensityDescription: 'Mede a densidade de conexões entre os vizinhos imediatos de um nó. Quantifica a coesão local ao redor de um nó.',
        eigenvectorLaplacian: 'Eigenvector (Laplaciano) - para layout Espectral',
        eigenvectorLaplacianDescription: 'Centralidade de eigenvector Laplaciano usada para análise espectral de grafos. Útil para algoritmos de layout espectral.',
        ...
        pageRankName: 'PageRank',
        cliquesName: 'Cliques',
        closenessName: 'Proximidade',
        egoDensityName: 'Densidade Ego',
        highlightCliqueEdges: '🎨 Destacar Arestas de Cliques',
        cliqueEdgesDescription: 'Colorir arestas que fazem parte de triângulos/cliques'
      },
      layoutAlgorithm: {
...
// Análise executada em workers para desempenho ideal!`
    ...
    explorer: {
      ...
      graphStats: {
        ...
        avgDegree: 'Grau Médio',
        connectedComponents: 'Componentes',
